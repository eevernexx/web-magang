                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image text-center align-self-center">
                                <img src="{{ asset('template/img/logokominfo.png') }}" alt="Logo Kominfo" style="max-width: 80%; height: auto;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4" style="font-family: 'Poppins', sans-serif;">Login KominfoMuda</h1>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="/new-account">Buat Akun Baru!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
