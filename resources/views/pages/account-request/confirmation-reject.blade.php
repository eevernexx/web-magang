<div class="modal fade" id="confirmationReject{{ $item->id }}" tabindex="-1" aria-labelledby="comfirmationRejectlLabel" aria-hidden="true">
    ...
    @method('POST')
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="comfirmationRejectlLabel">Konfirmasi Penolakan</h1>
